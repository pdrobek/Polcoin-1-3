...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/polcoin_testnet"));
            setWindowIcon(QIcon(":icons/polcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/polcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Polcoin client"));
